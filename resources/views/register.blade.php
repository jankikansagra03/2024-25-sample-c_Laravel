    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8 col-xs-12 col-sm-12">
                <form action="{{ URL::to('/') }}/register_action" method="post" enctype="multipart/form-data" id="form1">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="repwd" placeholder="Enter password"
                            name="repswd">
                    </div>
                    <br>
                    <div class="form-group">
