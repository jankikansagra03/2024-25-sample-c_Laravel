                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-90">
                                <li class="nav-item">
                                    <a class="nav-link @if ($parts[0] == 'index') active btn btn-success @endif"
                                        aria-current="page" href="{{ URL::to('/') }}/index">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @if ($parts[0] == 'gallery') active btn btn-success @endif"
                                        href="{{ URL::to('/') }}/gallery">Gallery</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @if ($parts[0] == 'about') active btn btn-success @endif"
                            ...
                            &nbsp;&nbsp;
                            <a href="{{ URL::to('/') }}/register"><button class="btn btn-success" type="button">Sign
                                    Up</button></a>&nbsp;&nbsp;
                            <a href="{{ URL::to('/') }}/login"><button class="btn btn-success" type="button">Sign
                                    In</button></a>&nbsp;
                        </div>
                    </div>
                </nav>
